...
<title>Request Custom Tour</title>
...
<div class="banner">
	...
	<div class="mid">
    	<div class="ptit">
    		<h1><span style="background:#FFF; padding:0 25px;">Request Custom Tour</span></h1>
        </div><!--ptit-->
        ...
        <div class="lcont">
            ...
            <div class="tripbox">
            	<div class="tdes">
            	<p>
                	AbcdNote: All the fields mentioned in inquiry form is mandatory. Please submit your correct details and help us make your holiday trips a special one to remember.
                </p>
            </div><!--tdes-->
