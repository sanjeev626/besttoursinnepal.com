...
{	
...

	{
		...
		{		
			...
			$service= $_POST['serviceOld'][$itid][$i];
			print_r($service);
	...
	?>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="TitleBarB"><strong>Service :</strong><a href="javascript:void(0);" id="addservice-<?php echo $iid;?>" class="button" onclick="draw_desp('<?php echo $iid;?>')">Add</a>&nbsp;<a href="#" id="removeservice-<?php echo $iid;?>" class="button" onclick="delete_rows('<?php echo $iid;?>')">Remove</a><br /><br />
            
            <table id="table-<?php echo $iid?>" border="0" cellspacing="0" cellpadding="0">
            <?php
            if($rasItinerary['services']!=NULL){
				
			$services = explode('----',$rasItinerary['services']);
			for($j=0; $j<count($services);$j++)
			{?>
				<tr>
                	<td><input name="serviceOld[<?php echo $flag;?>][]" type="text" class="inputbox" value="<?php echo $services[$j];?>"></td>
                </tr>	
			<?php 
			}
			$flag++;
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="TitleBarB"><strong>Service :</strong>
              <a href="#" id="addservice-<?php echo $i;?>" class="button" onclick="draw_desp('<?php echo $i;?>')">Add</a>&nbsp;<a href="#" id="removeservice-<?php echo $i;?>" class="button" onclick="delete_rows('<?php echo $i;?>')">Remove</a><br /><br />
    ...
    <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td class="TitleBarB"><strong>Service :</strong><br><input name="food" type="text" class="inputbox"></td>
