...
<ul>
  ...
  <li id="daytrips"><a href="<?php echo SITEROOT.$mydb->getValue('urlcode','tbl_activity','id=5').'.html';?>">DAY TRIPS</a></li>
...
<div class="menudrop">
  <div class="menublock1">
    ...
    <!--mstitle-->
    <div class="msimg"> <img src="<?php echo SITEROOT;?>img/page/thumb/<?php echo $rasAbout['iconimage'];?>" /> </div>
    <!--msimg-->
  ...
  <div class="menublock1">
    ...
    <!--mstitle-->
    <div class="msimg"> <img src="<?php echo SITEROOT;?>img/page/thumb/<?php echo $rasTeam['iconimage'];?>" /> </div>
    <!--msimg-->
  ...
  <div class="menublock1">
    ...
    <!--mstitle-->
    <div class="msimg"> <img src="<?php echo SITEROOT;?>img/page/thumb/<?php echo $rasWhy['iconimage'];?>" /> </div>
    <!--msimg-->
...
<div class="menudrop1">
<?php
$resActivity = $mydb->getQuery('id,urlcode,title,activityimage','tbl_activity','1 ORDER BY ordering LIMIT 5');
