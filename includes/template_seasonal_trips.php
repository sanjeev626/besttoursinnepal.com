    	<div class="ptit">
    		<h1><span style="background:#FFF; padding:0 25px;">Seasonal Trips - 2018 / 2019</span></h1>
            <p><?php echo stripslashes($mydb->getValue('contents','tbl_page','id=21'));?></p>
        </div><!--ptit-->
        <div class="triplist">
        	<?php
			$resFixed = $mydb->getQuery('*','tbl_package','is_seasonal_trip="1"');
            ...
            <form id="frmJoin" method="post" action="<?php echo $packageurl; ?>">
